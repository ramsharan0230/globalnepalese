...
<div class="content">
	...
	@endif
<form method="post" action="{{route('advert.update',$detail->id)}}" enctype="multipart/form-data" id="editor">
	{{csrf_field()}}
		...
		<div class="col-md-5">
			<div class="box box-primary">
				<div class="box-header with-heading">
					<h3 class="box-title">Edit Advert</h3>
				</div>
				<div class="box-body">
		...
		<div class="col-md-7">
			<div class="box box-warning">
				...
				<div class="box-body">
					...
					@foreach($section_options as $key=>$option)

					
						<div class="col-md-6">
							<div class="form-group">
								<label for="{{$key}}"><input type="checkbox" id="{{$key}}" name="sections[]" {{ in_array($key, $selected) ? 'checked' : '' }} value="{{$key}}"> {{$option}} </label>
				    		</div>
				    	</div>
				    @endforeach
					</div>
