...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>Global</b>Nepalese</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs">Global Nepalese</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{asset('images/thumbnail/'.$dashboard_composer->logo)}}"  alt="User Image" style="max-width: 120px;" >
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          @if($role=="admin" || ($role=="staff" && (in_array("tag",$user_access))))
         <li class="treeview ">
          <a href="#">
            <i class="fa fa-sliders"></i> <span>Tags</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class=""><a href="{{route('tag.create')}}"><i class="fa fa-circle-o text-yellow"></i> Add Tag</a></li>
            <li class=""><a href="{{route('tag.index')}}"><i class="fa fa-circle-o text-aqua"></i> All Tags</a></li>
          </ul>
        </li>
        @endif
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="{{route('category.index')}}"><i class="fa fa-circle-o text-aqua"></i> All Categories</a></li>
          </ul>
        </li>
        ...
        @endif
        @if($role=="admin" || ($role=="staff" && (in_array("video",$user_access))))
        <li class="treeview ">
          <a href="#">
            <i class="fa fa-sliders"></i> <span>Video</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class=""><a href="{{route('video.create')}}"><i class="fa fa-circle-o text-yellow"></i> Add Video</a></li>
            <li class=""><a href="{{route('video.index')}}"><i class="fa fa-circle-o text-aqua"></i> All Videos</a></li>
          </ul>
        </li>
        @endif
        @if($role=="admin" || ($role=="staff" && (in_array("advert",$user_access))))
        <li class="treeview ">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="{{route('advert.create')}}"><i class="fa fa-circle-o text-yellow"></i> Add Advertisement</a></li>
            <li class=""><a href="{{route('advert.index')}}"><i class="fa fa-circle-o text-aqua"></i> All Advertisements</a></li>
          </ul>
        </li>
        @endif
        ...
        @endif
        @if($role=="admin" || ($role=="staff" && (in_array("team",$user_access))))
        <li class="treeview ">
          <a href="#">
